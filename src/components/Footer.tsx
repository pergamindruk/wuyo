                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm flex flex-col gap-2">
                                <li><Link href="#" className="flex items-center gap-2 text-white/60 hover:text-white transition-colors group"><Youtube size={18} className="group-hover:text-red-500 transition-colors" /> YouTube</Link></li>
                                <li><Link href="#" className="flex items-center gap-2 text-white/60 hover:text-white transition-colors group"><Instagram size={18} className="group-hover:text-pink-500 transition-colors" /> Instagram</Link></li>
                            </ul>
                        </div>
                        <div>
